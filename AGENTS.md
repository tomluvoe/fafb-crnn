...
Closed: Phase 0 (#5) through Phase 5 (#10). Next: Phase 6 controls
(#11). Related: Animals-10 (#12), L1/L2 ON/OFF encoding (#13).
...
Follow open GitHub issues. Do not redo closed Phase 0–5 work unless
those scripts are broken.
